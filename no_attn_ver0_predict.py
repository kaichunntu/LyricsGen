...
with Seq_g.as_default():
    ...
    with tf.name_scope("Encoder"):
        e_cell0 = tf.contrib.rnn.LSTMCell(300,name="E_layer_0",reuse=False)
        e_cell1 = tf.contrib.rnn.LSTMCell(300,name="E_layer_1",reuse=False)
    ...
    with tf.name_scope("Decoder"):
        ...
        D_layer_0 , D_state_0 = Encoder(y_vector,300,"rnn/E_layer_0",init_state=E_state_0,reuse=True,
...
#                                                        init_state=E_state_1,t_len=Decoder_max_len-1,stack_flag=False)
        D_layer_1 , D_state_1 = Encoder(D_layer_0,300,"rnn/E_layer_1",init_state=E_state_1,reuse=True,
...
#         _loss = -tf.reduce_mean(cross_entropy)
    ...
    with tf.name_scope("Inference"):
        ...
        infer_logits_seq = []
        for t in range(Decoder_max_len-1):
            tmp = Encoder([infer_out],300,"rnn/E_layer_0",init_state=infer_state_0,reuse=True,
...
#             infer_layer_1 , infer_state_1 , infer_score = tmp
            tmp = Encoder(infer_layer_0,300,"rnn/E_layer_1",init_state=infer_state_1,reuse=True,
                          t_len=1,stack_flag=False)
