...
pre_trained_path = "../task3_1/Attn_ver1/model_para/model_60.ckpt"
Encoder_max_len = 60
Decoder_max_len = 30
min_count = 3
print_interval = 2000
...
train_path = ["data/{}/train.csv".format(x) for x in ["all","pos","rhyme","length"]]
test_path = ["data/{}/test.csv".format(x) for x in ["all","pos","rhyme","length"]]
...
#             infer_layer_1 , infer_state_1 = tmp
    ...
    saver = tf.train.Saver(max_to_keep=6,var_list=tf.global_variables())
