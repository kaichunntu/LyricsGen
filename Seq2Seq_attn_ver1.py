...
with Seq_g.as_default():
    ...
    with tf.name_scope("Encoder"):
        e_cell0 = tf.contrib.rnn.LSTMCell(512,name="E_layer_0",reuse=False)
    ...
    with tf.name_scope("Decoder"):
        ...
        D_layer_0 , D_state_0 = Encoder(y_vector,512,"rnn/E_layer_0",init_state=E_state_0,reuse=True,
                                        t_len=Decoder_max_len-1,stack_flag=True)
        D_layer_1 , D_state_1 , D_score = attn_Decoder(D_layer_0,E_layer_1,in_mask,512,name="Attn_D_layer_1",
...
#         _loss = -tf.reduce_mean(cross_entropy)
    ...
    with tf.name_scope("Inference"):
        ...
        infer_logits_seq = []
        for t in range(Decoder_max_len-1):
            tmp = Encoder([infer_out],512,"rnn/E_layer_0",init_state=infer_state_0,reuse=True,
                          t_len=1,stack_flag=False)
            infer_layer_0 , infer_state_0 = tmp
            
            tmp = attn_Decoder(infer_layer_0,E_layer_1,in_mask,512,name="Attn_D_layer_1",
